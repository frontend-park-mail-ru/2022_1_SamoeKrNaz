...
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['signupPage'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = container.invokePartial(lookupProperty(partials,"decoration"),depth0,{"name":"decoration","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + ((stack1 = container.invokePartial(lookupProperty(partials,"descp"),depth0,{"name":"descp","hash":{"descpText":"Авторизация необходима для работы в команде. Зарегистрируйся и начинай работать эффективней!"},"data":data,"indent":"        ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + ((stack1 = container.invokePartial(lookupProperty(partials,"input"),depth0,{"name":"input","hash":{"inputId":"input_pass_rep","inputType":"password","inputPlaceholder":"Повторите пароль"},"data":data,"indent":"            ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + ((stack1 = container.invokePartial(lookupProperty(partials,"button"),depth0,{"name":"button","hash":{"buttonText":"Зарегистрироваться"},"data":data,"indent":"            ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "        </form>\r\n        <div class=\"auth__block_signup\">\r\n            <div class=\"auth__block_dont\">\r\n                Уже зарегистрированы?\r\n            </div>\r\n            <div>\r\n                <a class=\"auth__block_link\" href=\"signup.html\">Войти</a>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n";
