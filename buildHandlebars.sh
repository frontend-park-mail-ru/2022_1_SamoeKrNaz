handlebars src/components/button/button.handlebars > src/loginPage/loginPage.templ.js &&
handlebars src/components/decoration/decoration.handlebars >> src/loginPage/loginPage.templ.js
handlebars src/components/descp/descp.handlebars >> src/loginPage/loginPage.templ.js &&
handlebars src/components/error/error.handlebars >> src/loginPage/loginPage.templ.js &&
handlebars src/components/headTitle/headTitle.handlebars >> src/loginPage/loginPage.templ.js &&
handlebars src/components/input/input.handlebars >> src/loginPage/loginPage.templ.js &&
handlebars src/components/logo/logo.handlebars >> src/loginPage/loginPage.templ.js &&
handlebars src/loginPage/loginPage.handlebars >> src/loginPage/loginPage.templ.js

handlebars src/components/button/button.handlebars > src/signupPage/signupPage.templ.js &&
handlebars src/components/decoration/decoration.handlebars >> src/signupPage/signupPage.templ.js &&
handlebars src/components/descp/descp.handlebars >> src/signupPage/signupPage.templ.js &&
handlebars src/components/error/error.handlebars >> src/signupPage/signupPage.templ.js &&
handlebars src/components/headTitle/headTitle.handlebars >> src/signupPage/signupPage.templ.js &&
handlebars src/components/input/input.handlebars >> src/signupPage/signupPage.templ.js &&
handlebars src/components/logo/logo.handlebars >> src/signupPage/signupPage.templ.js &&
